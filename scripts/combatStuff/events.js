...
function entityDie(data) {
    ...
    if (deadEntity instanceof server.Player) {
        ...
        if (killer instanceof server.Player) {
            ...
            world.sendMessage(`§a${killer.name} §rrozwalił(a) §c${deadEntity.name} §rjak tanią zabawkę z TEMU! ` +
